...
\end{definition}
An equivalent formulation of the Cantor set, is the decimal expansion of all numbers in $[0,1]$ in base $3$, omitting any representation with a $1$.  
...
\end{claim}
Notice that $[0,1]\setminus \mcC$ is a set of open intervals: 
