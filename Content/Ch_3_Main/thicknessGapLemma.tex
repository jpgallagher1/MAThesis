...
\begin{definition}[Gap]
    Let $K$ be some Cantor set.  A \underline{gap} of $K$ is a connected component of $\R \setminus K$.      
...
Using these two notions we will define the \underline{bridge} $C$ of Cantor set $K$.  
\begin{definition}[Bridge]\cite{palis&takens}
    Let $K$ be some cantor set and $U$ be a bounded gap of $K$ with boundary point $u$.  The \underline{bridge} $C$ of $K$ at $u$ is the maximal interval in $\R$ such that:
    \begin{itemize}
...
We use this notion to define the \underline{Newhouse Thickness}.  Intuitively the thickness of a Cantor set can be thought of as a the infimimum of ratios between the bounded gaps and the bridges.  
\begin{definition}[Newhouse Thickness \cite{palis&takens}]
    Let $K$ be some cantor set and $U$ be a bounded gap of $K$ with boundary point $u$ and let $C$ be the bridge $K$ at $u$.  The \underline{Newhouse Thickness or thickness of $K$ at $u$} is defined as
    $$\tau(K, u) = \frac{\ell(C)}{\ell(U)}.$$
    Moreover for $\mathcal{U} = \{ \text{boundary points of bounded gaps}\}$, the thickness of the entire Cantor set is 
...
Here we will calculate a few examples of Newhouse Thickness.  
