...
Using this result we can answer a question of Sevtic with Cantor set of positive Newhouse thickness and thus the original Erd\H{o}'s similarity conjecture for some uncountable nowhere dense set. 
