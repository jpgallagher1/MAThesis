...
\input{Content/Ch_Mes&Top/bigOrSmall.tex}
\input{Content/Ch_Mes&Top/cantorSets.tex}
\input{Content/Ch_Mes&Top/baireCategory.tex}
\chapter{An Erd\"{o}s Conjecture in Measure Theory}
\input{Content/Ch_Erdos_Conj/affineCopies.tex}
\input{Content/Ch_Erdos_Conj/erdosSimilarity.tex}
\chapter{An Erd\"{o}s Similarity Problem in a Topological Setting}
\input{Content/Ch_Main/thicknessGapLemma.tex}
\input{Content/Ch_Main/positiveNewhouseThickness.tex}
\input{Content/Ch_Main/activeWorkingQuestions.tex}
